...
import datadogapi "github.com/DataDog/datadog-agent/pkg/trace/api"

const (
	// v01 is DEPRECATED
	v01 datadogapi.Version = "v0.1"

	// v02 is DEPRECATED
	v02 datadogapi.Version = "v0.2"

	// v03
	// Traces: msgpack/JSON (Content-Type) slice of traces
	v03 datadogapi.Version = "v0.3"

	// v04
	// Traces: msgpack/JSON (Content-Type) slice of traces + returns service sampling ratios
	v04 datadogapi.Version = "v0.4"
