...
require (
	...
	github.com/DataDog/datadog-agent/pkg/otlp/model v0.37.1 // indirect
	github.com/DataDog/datadog-agent/pkg/remoteconfig/client v0.37.1 // indirect
	github.com/DataDog/datadog-agent/pkg/trace v0.37.1 // indirect
